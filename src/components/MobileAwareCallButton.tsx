  ...
  return isMobile ? (
    <a
      ...
      className="inline-flex items-center gap-2 text-black px-6 py-2.5 rounded-full text-sm font-medium 
                 ...
                 hover:shadow-[2px_2px_4px_rgba(0,0,0,0.12),-2px_-2px_4px_rgba(255,255,255,0.9)] 
    ...
    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl shadow-[inset_2px_2px_4px_rgba(0,0,0,0.06),inset_-2px_-2px_4px_rgba(255,255,255,0.5)]" style={{ background: 'linear-gradient(to bottom, #f9fafb, #f3f4f6)' }}>
